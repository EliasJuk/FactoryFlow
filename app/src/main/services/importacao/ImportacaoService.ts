...
async function executarImportacao(
  ...
  switch (tipo) {
    ...
    case 'subsetores': {
      if (usuarioId == null) {
        throw new Error('Usuário autenticado é obrigatório para importar subsetores.')
      }
    ...
    case 'componentes': {
      if (usuarioId == null) {
        throw new Error('Usuário autenticado é obrigatório para importar componentes.')
      }
    ...
    case 'circuitos': {
      if (usuarioId == null) {
        throw new Error('Usuário autenticado é obrigatório para importar circuitos.')
      }
