...
import type { SetorSyncPayload } from '../sync.types'

export class PostgresSetorSyncRepository {
  async apply(payload: SetorSyncPayload): Promise<void> {
